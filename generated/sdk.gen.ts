...
export class ConsumptionService {
     ...
     *
     * @param data The data for the request.
     * @param data._from Specify the start `date-time` for the consumption period.
