...
export const $OuterbaseWorkspace = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
...
export const $GithubAppProjectResponse = {
    type: 'object',
    properties: {
        project_id: {
            type: 'string',
        ...
        repositories: {
            type: 'array',
            items: {
                '$ref': '#/components/schemas/GithubAppRepository'
            },
...
export const $OuterbaseProjectResponse = {
    type: 'object',
    properties: {
        project_id: {
            type: 'string',
        ...
        workspaces: {
            type: 'array',
            items: {
                '$ref': '#/components/schemas/OuterbaseWorkspace'
            },
...
export const $OuterbaseWorkspaceUpdateRequest = {
    type: 'object',
...
export const $Branch = {
    type: 'object',
    required: ['id', 'project_id', 'name', 'current_state', 'creation_source', 'created_at', 'updated_at', 'primary', 'protected', 'cpu_used_sec', 'active_time_seconds', 'compute_time_seconds', 'written_data_bytes', 'data_transfer_bytes'],
    properties: {
        id: {
...
export const $BillingAccount = {
    type: 'object',
    required: ['payment_source', 'subscription_type', 'quota_reset_at_last', 'email', 'address_city', 'address_country', 'address_line1', 'address_line2', 'address_postal_code', 'address_state'],
    properties: {
        payment_source: {
...
export const $BillingAccountResponse = {
    type: 'object',
    required: ['billing_account'],
    properties: {
        billing_account: {
...
`,
    enum: ['UNKNOWN', 'free', 'pro', 'direct_sales', 'aws_marketplace', 'free_v2', 'launch', 'scale']
} as const;
...
export const $OrganizationLimits = {
    ...
    properties: {
        limits: {
            type: 'object',
            required: ['active_time', 'max_projects', 'max_branches', 'max_autoscaling_cu', 'cpu_seconds', 'max_active_endpoints', 'max_read_only_endpoints', 'max_allowed_ips', 'max_monitoring_retention_hours', 'max_history_retention_seconds', 'max_compute_time_non_primary'],
            properties: {
                active_time: {
                    type: 'integer',
                    format: 'int64'
